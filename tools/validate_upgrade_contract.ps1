...
Assert-Text 'effects\geometric\halo_text_logo_tunnel.effect' 'customRingCharAt' 'Halo Text Logo Tunnel is missing custom ring text decoding.'
Assert-Text 'effects\geometric\halo_text_logo_tunnel.effect' 'choice == 6' 'Halo Text Logo Tunnel is missing BOSO as text preset 6.'
Assert-Text 'effects_meta\halo_text_logo_tunnel.json' 'ring4_char_11' 'Halo Text Logo Tunnel metadata does not expose hidden custom ring text uniforms.'
Assert-Text 'effects_meta\halo_text_logo_tunnel.json' '"BOSO"' 'Halo Text Logo Tunnel metadata does not expose BOSO as default text.'
Assert-Text 'web-ui\vjlink-control.html' 'renderHaloRingTextPanel' 'Web UI is missing Halo custom ring text controls.'
