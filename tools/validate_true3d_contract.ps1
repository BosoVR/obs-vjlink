...
Require-Text 'src/rendering/compositor.c' 'screen_ring' 'screen ring uses the 3D compositor branch'
Require-Text 'effects/geometric/screen_ring.effect' 'screen_y_motion' 'screen ring vertical motion control'
Require-Text 'effects/geometric/screen_ring.effect' 'screen_orbit_speed' 'screen ring orbit speed control'
Require-Text 'effects/geometric/screen_ring.effect' 'screen_segments' 'screen ring segmented band control'
Require-Text 'effects/geometric/screen_ring.effect' 'screen_arc' 'screen ring curved screen arc control'
Require-Text 'effects/geometric/screen_ring.effect' 'logo_spin_y' 'screen ring center logo spin control'
...
Require-Text 'src/rendering/effect_system.c' 'p_view_proj\s*=.*ViewProj' 'ViewProj parameter is cached for real 3D'
Require-Text 'effects/3d/logo_extrude_3d.effect' 'technique DrawMesh' 'logo mesh shader technique'
Require-Text 'effects/geometric/screen_ring.effect' 'technique DrawMesh' 'screen ring mesh shader technique'
Require-Text 'effects/geometric/screen_ring.effect' 'mesh_text_lane' 'screen ring mesh lane text uniform'
Require-Text 'effects/geometric/screen_ring.effect' 'true3d_mode' 'screen ring true 3D background mode'
