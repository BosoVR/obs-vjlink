...
static const char *g_about_text =
	"OBS-VJLink v1.0.0\r\n"
	"VJ Visuals & Audio-Reactive Effects for OBS Studio\r\n"
	"\r\n"
	"=== FEATURES ===\r\n"
	"\r\n"
	"--- Audio Analysis ---\r\n"
	"Captures audio via VJLink Audio Filter. Real-time FFT "
	"(2048-point, 48kHz). Extracts 4 frequency bands:\r\n"
	"  Bass (23-234 Hz) - Kicks, sub-bass\r\n"
	"  Low-Mid (234-984 Hz) - Synths, vocals\r\n"
	"  High-Mid (984-3984 Hz) - Snares, leads\r\n"
	"  Treble (3984-12000 Hz) - Hi-hats, cymbals\r\n"
	"\r\n"
	"--- BPM Detection ---\r\n"
	"Automatic BPM (80-230 range, Hardtechno/Rawstyle). "
	"Spectral flux + autocorrelation + PLL beat tracking. "
	"Manual tap-tempo via hotkey.\r\n"
	"\r\n"
	"--- 43 Shader Effects ---\r\n"
	"Tunnels, Plasma, Particles, Fractals, Geometric, "
	"Glitch, Retro, 3D, Audio Viz, Flash/Strobe, "
	"Post-processing. All audio-reactive HLSL.\r\n"
	"\r\n"
	"--- Compositor Source ---\r\n"
	"Add 'VJLink Compositor' to any scene. Renders effects "
	"with audio-reactive parameters, stacking, feedback.\r\n"
	"\r\n"
	"--- Effect Filter ---\r\n"
	"Add 'VJLink Effect' filter on any source for VJ "
	"shader effects on video, webcams, etc.\r\n"
	"\r\n"
	"--- Per-Band Effects ---\r\n"
	"Assign effects per frequency band (AudioLink-style). "
	"Independent threshold + intensity per band.\r\n"
	"\r\n"
	"--- 3D Engine + Particles ---\r\n"
	"Procedural meshes, orbit camera, 16384 GPU particles "
	"with audio-reactive forces.\r\n"
	"\r\n"
	"--- Presets ---\r\n"
	"12 built-in presets. Custom JSON presets with LFO, "
	"audio-band, beat-envelope animations.\r\n"
	"\r\n"
	"--- Video Wall ---\r\n"
	"Multi-screen output for LED walls / projection.\r\n"
	"\r\n"
	"--- Source Triggers ---\r\n"
	"Control OBS source visibility based on audio bands. "
	"Band/Beat/Gate trigger modes.\r\n"
	"\r\n"
	"--- Web UI ---\r\n"
	"Built-in HTTP server with control panel. Access from "
	"any browser on same network.\r\n"
	"\r\n"
	"--- Hotkeys ---\r\n"
	"Next/Prev Preset, Tap Beat, Blackout, Preset 1-10.\r\n"
	"\r\n"
	"--- obs-websocket API ---\r\n"
	"16 vendor request types for full automation.\r\n"
	"\r\n"
	"=== HOW TO USE ===\r\n"
	"\r\n"
	"1. Add 'VJLink Audio Filter' to audio source\r\n"
	"2. Add 'VJLink Compositor' source to scene\r\n"
	"3. Select effect in compositor properties\r\n"
	"4. Play music - visuals react automatically\r\n"
	"5. Open Web UI for advanced controls\r\n"
	"6. Optional: 'VJLink Effect' filter on sources\r\n"
	"7. Optional: 'VJLink Video Wall' for multi-output\r\n";
